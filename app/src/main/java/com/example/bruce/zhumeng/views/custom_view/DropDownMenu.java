...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        underlineColor = a.getColor(R.styleable.DropDownMenus_ddmDividerColor, underlineColor);
        dividerColor = a.getColor(R.styleable.DropDownMenus_ddmUnderlineColor, dividerColor);
        ...
        maskColor = a.getColor(R.styleable.DropDownMenus_ddmMaskViewColor, maskColor);
        menuTextSize = a.getDimensionPixelSize(R.styleable.DropDownMenus_ddmMenuTextSize, menuTextSize);
        menuSelectedIcon = a.getResourceId(R.styleable.DropDownMenus_ddmSelectedIcon, menuSelectedIcon);
        menuUnselectedIcon = a.getResourceId(R.styleable.DropDownMenus_ddmUnselectedIcon, menuUnselectedIcon);
        a.recycle();
